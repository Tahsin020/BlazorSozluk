...
internal class SeedData
{
    ...
    public async Task SeedAsync(IConfiguration configuration)
    {
        ...
        dbContextBuilder.UseSqlServer(configuration["BlazorSozlukDbConnectionString"].ToString());
        BlazorSozlukContext context = new BlazorSozlukContext(dbContextBuilder.Options);
        var users = GetUsers();
